...
class SetOrderProcessingStateTest extends AbstractTestCase
{
    /**
    ...
    {
        parent::setUp();
        $this->setOrderProcessingState = $this->getObjectManager()->create(SetOrderProcessingState::class);
    }
     ...
     * @throws Exception
     */
    public function testSetOrderProcessingSkip(): void
    {
        $order = $this->getOrder();
        $response = $this->setOrderProcessingState->execute($order, $this->getTransactionData());
     ...
     * @throws Exception
     */
    public function testSetOrderProcessing(): void
    {
        $order = $this->getOrder();
