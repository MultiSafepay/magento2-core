...
class DirectBankTransferValidator extends AbstractValidator
{
    ...
    public function validate(array $validationSubject): ResultInterface
    {
        ...
        if (empty($payment->getAdditionalInformation()['account_id'])) {
        ...
        if (empty($payment->getAdditionalInformation()['account_holder_city'])) {
            return $this->createResult(false, [__('The account holder city can not be empty')]);
        }

        if (empty($payment->getAdditionalInformation()['account_holder_country'])) {
        ...
        if (empty($payment->getAdditionalInformation()['account_holder_bic'])) {
