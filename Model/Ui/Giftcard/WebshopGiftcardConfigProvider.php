...
class WebshopGiftcardConfigProvider extends GenericConfigProvider
{
    public const CODE = 'multisafepay_webshopgiftcard';

    /**
     * WebshopGiftcardConfigProvider constructor.
     *
